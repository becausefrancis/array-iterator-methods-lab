...
// Hint: Use the String.prototype.split method to separate the first and last names. 
...
firstLast = firstLast.map((person) => {
...
totalYearsLived = inventors.reduce((age, inventor) => {
    return (inventor.passed - inventor.year) + age;
}, 0)
...
// Bonus 2. Tallying Travel Methods Using Array.prototype.reduce(). 
// Count the number of times each travel method appears in the 'travelMethods' array.
...
// Hints:
// - Inside the reduce function, check if the travel method already exists as a key in your accumulator object. 
